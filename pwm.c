...
uint8_t ui8_duty_cycle_direction = 0;
uint8_t ui8_value_new_A;
uint8_t ui8_value_new_B;
uint8_t ui8_value_new_C;
uint16_t ui16_value;

void pwm_set_duty_cycle(uint8_t value, uint8_t direction) {
	ui8_duty_cycle_target = value;
	ui8_duty_cycle_direction = direction;
}
...
#else
	pwm_apply_duty_cycle(ui8_duty_cycle_target, ui8_duty_cycle_direction);
#endif
}
...
void pwm_apply_duty_cycle(uint8_t ui8_duty_cycle_value, uint8_t ui8_duty_direction_value) {
#if (SVM_TABLE == SVM)
	...
	direction = ui8_duty_direction_value;
	...
	ui8_temp = fetch_table_value((uint8_t) (ui8_sinetable_position  + 85 /* 120° 85 */));
	...
	ui8_temp = fetch_table_value((uint8_t) (ui8_sinetable_position + 171/* 240° 171*/));
	if (ui8_temp > MIDDLE_PWM_VALUE_DUTY_CYCLE_MAX) {
		ui16_value = ((uint16_t) (ui8_temp - MIDDLE_PWM_VALUE_DUTY_CYCLE_MAX)) * ui8__duty_cycle;
		ui8_temp = (uint8_t) (ui16_value >> 8);
