...
// исходный вариант "1" против часовой, если смотреть на qr код
...
/*
#define PMW_PHASE_B_LOW__PIN      GPIO_PIN_2
#define PMW_PHASE_B_LOW__PORT     GPIOB
#define PMW_PHASE_B_HIGH__PIN     GPIO_PIN_3
#define PMW_PHASE_B_HIGH__PORT    GPIOC


#define PMW_PHASE_C_LOW__PIN      GPIO_PIN_1
#define PMW_PHASE_C_LOW__PORT     GPIOB
#define PMW_PHASE_C_HIGH__PIN     GPIO_PIN_2
#define PMW_PHASE_C_HIGH__PORT    GPIOC


#define PMW_PHASE_A_LOW__PIN      GPIO_PIN_0
#define PMW_PHASE_A_LOW__PORT     GPIOB
#define PMW_PHASE_A_HIGH__PIN     GPIO_PIN_1
#define PMW_PHASE_A_HIGH__PORT    GPIOC 
...
/*#define PMW_PHASE_A_LOW__PIN      GPIO_PIN_1 не работает
#define PMW_PHASE_A_LOW__PORT     GPIOB
#define PMW_PHASE_A_HIGH__PIN     GPIO_PIN_2
#define PMW_PHASE_A_HIGH__PORT    GPIOC


#define PMW_PHASE_B_LOW__PIN      GPIO_PIN_0
#define PMW_PHASE_B_LOW__PORT     GPIOB
#define PMW_PHASE_B_HIGH__PIN     GPIO_PIN_1
#define PMW_PHASE_B_HIGH__PORT    GPIOC


#define PMW_PHASE_C_LOW__PIN      GPIO_PIN_2
#define PMW_PHASE_C_LOW__PORT     GPIOB
#define PMW_PHASE_C_HIGH__PIN     GPIO_PIN_3
#define PMW_PHASE_C_HIGH__PORT    GPIOC 
*/
...
#define DEBUG__PIN                  GPIO_PIN_1
#define DEBUG__PORT                 GPIOG
